...
namespace lemon {
  ...
  public:
	...
	void SetDeallocMapping(bool value)
	{
		_deallocMappingAfterUse = value;
	}
	void SetDeallocLabels(bool value)
	{
		_deallocLabelsAfterUse = value;
	}
  ...
  public:
    ...
    getPtrToVf2ppObject(){
      ...
      if(Base::_local_mapping)
		...
		ptr->SetDeallocMapping(true);
      if(Base::_local_nodeLabels)
        //ptr->_deallocLabelMapsAfterUse=true;
		ptr->SetDeallocLabels(true);
